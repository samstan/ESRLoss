...
Then run parse.py on the extracted files (of which there are ten). Then run ads.py, which relies on learners_discrete.py to train models; note that ads.py is a template for running on the first day's data.
